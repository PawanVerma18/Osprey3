...
namespace Osprey3.Views
{
    public partial class MainScreen : ContentPage
    {
        ...
        private async void OnSignupClicked(object sender, EventArgs e)
        {
            try
            {
                // Navigate to Registration page and pass IUserService
                await Navigation.PushAsync(new Registration(_userService));
            }
            catch (Exception ex)
            {
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        await DisplayAlert("Error", "User does not exist. Please register.", "OK");
                    }
                }
            }
